...
{
    public class SitePartWorker_M4Arrival : SitePartWorker_DownedRefugee
    {
        public override void Notify_GeneratedByQuestGen(SitePart part, Slate slate, List<Rule> outExtraDescriptionRules, Dictionary<string, string> outExtraDescriptionConstants)
        {
            base.Notify_GeneratedByQuestGen(part, slate, outExtraDescriptionRules, outExtraDescriptionConstants);
            Pawn pawn = PawnGenerator.GeneratePawn(new PawnGenerationRequest(ATM_PawnKindDefOf.ATM_M4JellymanColony, Faction.OfAncients, PawnGenerationContext.NonPlayer, part.site.Tile, forceGenerateNewPawn: true, canGeneratePawnRelations: false, mustBeCapableOfViolence: false, allowFood: false, allowAddictions: false));
